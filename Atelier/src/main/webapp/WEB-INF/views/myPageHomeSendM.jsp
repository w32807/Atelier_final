					...
					<div class="row">
						<div class="col-md-12">
							<h2 class="colorlib-heading animate-box" data-animate-effect="fadeInLeft"
								style="font-weight: bolder; font-size: 23px; letter-spacing: 0.5px;">판매자에게 문의<hr>
							</h2>
						</div>
					</div>
										...
										<div class="panel-heading" role="tab" id="heading1">
											<h4 class="panel-title">
										    	<a class="collapsed"  href="#collapse1" aria-expanded="false" aria-controls="collapse1"
										        	...
										        	<i class="icon_mail_alt"></i> 받는 사람: ${reciever}
										        </a>
										    </h4>
										</div>
										<form id="messageFrm" action="myPageMSendAction" method="post">
											<textarea id="messageContents" rows="10" cols="45" name="mg_contents"
													style="margin-top: 5px; font-size: 15px; resize: none; width: 375px; color: black;" placeholder="여기에 작성해주세요."></textarea>
											<input type="hidden" name="mg_receiver" value=${reciever}><!-- 송신자의 아이디는 session에 담겨있을테니 여기서 안 보내도 됨. -->
										</form>								
									</div>
									<div class="panel panel-default">
									<!-- 여기까지 쪽지 1개 -->
